...
export function Pirate(props) {
  ...
  const { currentItem } = useCollectionGenerator();
  const animationIndex = names.indexOf(currentItem.Pose.value);
  useEffect(() => {
